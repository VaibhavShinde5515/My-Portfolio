      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/VaibhavShinde5515/Nivesh-Financial-Planning-and-Investment-Advisor-.git" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Women Safety Analytics System</h3>
              <p> An AI-driven system that uses real-time object detection to identify unsafe behaviors and trigger instant alerts. It enhances security by monitoring environments continuously and responding proactively to threats. Ideal for surveillance, workplace safety, and public security applications. </p>
            </div>
            <footer> <ul className="tech-list"> <li>YOLO</li> <li>OpenCV</li> <li>React</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Brain Tumor Detection Using MRI Scans</h3>
              <p>An AI-powered system that detects brain tumors from MRI images using deep learning techniques such as CNNs. The model classifies tumors with high accuracy and highlights affected regions for clinical interpretation. It aids in early diagnosis, reducing manual error and accelerating medical decision-making. Suitable for integration into healthcare diagnostics tools.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
